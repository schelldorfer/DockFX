                      ...
                      implements EventHandler<MouseEvent>
{
        ...
        false)
    {
        ...
        protected void invalidated()
        {
            ...
            // TODO: This is a work around to fill the screen bounds and not overlap the task bar
            // when
            // the window is undecorated as in Visual Studio. A similar work around needs applied
            // for
    ...
    public void setFloating(boolean floating, Point2D translation)
    {
        if (floating && !this.isFloating())
        {
            ...
            if (this.isDecorated())
            {
                ...
                stagePosition = floatScene.add(new Point2D(
    ...
    private BooleanProperty customTitleBarProperty = new SimpleBooleanProperty(
        true)
    {
        @Override
        public String getName()
    ...
    private BooleanProperty floatingProperty = new SimpleBooleanProperty(
        false)
    {
        @Override
        protected void invalidated()
    ...
    private BooleanProperty floatableProperty = new SimpleBooleanProperty(
        true)
    {
        @Override
        public String getName()
    ...
    private BooleanProperty closableProperty = new SimpleBooleanProperty(
        true)
    {
        @Override
        public String getName()
    ...
    private BooleanProperty stageResizableProperty = new SimpleBooleanProperty(
        true)
    {
        @Override
        public String getName()
    ...
    private BooleanProperty dockedProperty = new SimpleBooleanProperty(
        false)
    {
        @Override
        protected void invalidated()
    ...
    public void handle(MouseEvent event)
    {
        ...
        {
            Point2D sizeCurrent = new Point2D(
                event.getScreenX(), event.getScreenY());
            ...
            // TODO: find a way to do this synchronously and eliminate the flickering of moving the
            // stage
            // around, also file a bug report for this feature if a work around can not be found
            // this
            // primarily occurs when dragging north/west but it also appears in native windows and
            // Visual
